...
byte rowPins[ROWS] = {13, 12, 14, 27};                               // portas D11 a D8 conectadas nas linhas do Keypad
byte colPins[COLS] = {26, 25, 33, 32};                                 // portas D7 a D4  conectadas nas colunas do Keypad
//{12, 11, 13, 2
